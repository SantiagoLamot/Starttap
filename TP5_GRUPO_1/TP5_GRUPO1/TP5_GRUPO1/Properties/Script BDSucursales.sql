...
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Fravega', N'Venta de articulos electr�nicos', 1, 1, N'~/Imagenes/2.jpg',N'Libertador 16280')
...
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Aramark', N'Expertos en brindar servicios de alimentaci�n y gesti�n de instalaciones', 2, 3, N'~/Imagenes/4.jpg',N'Cerrito 3567')
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Daytona', N'Reparaci�n y colocaci�n de cubiertas', 2, 1, N'~/Imagenes/5.jpg',N'Constitucion 1899')
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Cafe Fundador', N'Lugar destinado para tomar distintos tipos de caf�', 1, 3, N'~/Imagenes/6.jpg',N'Hipolito Yrigoyen 2550')
...
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Sony', N'Accesorios y electrodom�sticos Sony', 6, 2, N'~/Imagenes/9.jpg',N'Avellaneda 223')
INSERT [dbo].[Sucursal] ( [NombreSucursal], [DescripcionSucursal], [Id_HorarioSucursal], [Id_ProvinciaSucursal], [URL_Imagen_Sucursal],[DireccionSucursal]) VALUES ( N'Starbucks Cofee', N'Starbucks vende caf� elaborado, bebidas calientes y otras bebidas, adem�s bocadillos.', 1, 3, N'~/Imagenes/10.jpg',N'San Nicolas 1200')
