    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style10">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtIDbuscar" ErrorMessage="*Debe Ingresar un Numero" ValidationExpression="^[0-9,$]*$" ValidationGroup="GFiltro" ForeColor="Red"></asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="revIDBuscar" runat="server" ControlToValidate="txtIDbuscar" ErrorMessage="*Ingrese un ID" ForeColor="Red" ValidationGroup="GFiltro">*Ingrese un ID</asp:RequiredFieldValidator>
                    <br />
            ...
            <tr>
                ...
                <td colspan="4">
                    <asp:GridView ID="gvSucursales" runat="server">
                        <AlternatingRowStyle BackColor="#660066" />
                        <EditRowStyle VerticalAlign="Middle" Wrap="False" />
