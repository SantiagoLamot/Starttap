...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <header><uc:menu runat="server" /> </header>
    ...
    <form id="form1" runat="server" class="auto-style2">
        ...
        <asp:GridView ID="gv_Ordenes" runat="server" AutoGenerateColumns="False" CssClass="auto-style1" AutoGenerateDeleteButton="True" OnRowDeleting="gv_Ordenes_RowDeleting">
    <Columns>
