              ...
              <td class="auto-style13" ><strong>Ingrese localidad:</strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style42">
                        ...
                        <asp:RegularExpressionValidator ID="revCodigoPostal" runat="server" ControlToValidate="tbId" Font-Names="Calibri" Font-Size="X-Small" ForeColor="#660066" ValidationExpression="\d{4}" ValidationGroup="GUsuario" Display="Dynamic">*Ingrese un Codigo  Postal Valido</asp:RegularExpressionValidator>
