Nombre de usuario:<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formulario.aspx.cs" Inherits="Grupo2_TP3._1.Formulario" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLocalidad" runat="server" ControlToValidate="txtLocalidad" ForeColor="Red" ValidationGroup="GrupoL" Display="Dynamic">Ingrese una localidad</asp:RequiredFieldValidator><asp:CustomValidator runat="server" ID="cvValidarLocaliadesRepetidas" ForeColor="Red" ControlToValidate="txtLocalidad" OnServerValidate="sv_LocaliadRepetida" ValidationGroup="GrupoL">La localidad ya esta registrada</asp:CustomValidator>   
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlLocalidades" runat="server"></asp:DropDownList>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
